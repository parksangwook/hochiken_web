    ...
    <section id="bo_v_atc">
      ...
      <div class="bo_v_con_1st_con">
       ...
       <div class="bo_v_con_1st_con">
        ...
        <div class="bo_v_con_1st_con">
            <p class='bo_v_con_1st'>메뉴명</p>  
            <p class='bo_v_con_1st_pr'><?php echo cut_str(get_text($view['wr_subject']), 70); // 글제목 출력 ?></p>
        </div> 
        <div class="bo_v_con_1st_con">
            <p class='bo_v_con_1st'>메뉴설명</p>  
            <p class='bo_v_con_1st_pr'><?php echo cut_str(get_text($view['wr_2']), 70); // 글제목 출력 ?></p>
        </div> 
        <div class="bo_v_con_1st_con">
            <p class='bo_v_con_1st'>BEST</p>  
            <p class='bo_v_con_1st_pr'><?php echo cut_str(get_text($view['wr_3']), 70); // 글제목 출력 ?></p>
        </div> 
        <div class="bo_v_con_1st_con">
            <p class='bo_v_con_1st'>NEW</p>  
