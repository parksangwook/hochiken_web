...
<div class="admin_top_div rltv">
    <img class="admin_top_img" src="/images/05_top_01.png">
    <div class="main_text absol">
      <p>Notice</p>
      <p>.</p>
    </div>
</div>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <div class="event-date-box">
        <span class="event-date">
            <?php echo $view['wr_2']; ?>
            <?php if ($view['wr_3']) { ?> ~ <?php echo $view['wr_3']; ?><?php } ?>
        </span>
    </div>
    <?php } ?>
...
<!--
        <div class="bo_v_con_1st_con">
            <p class='bo_v_con_1st'>출력순서</p>  
            <p class='bo_v_con_1st_pr'><?php echo cut_str(get_text($view['wr_1']), 70); // 글제목 출력 ?></p>
        </div> 
        <div class="bo_v_con_1st_con">
            <p class='bo_v_con_1st'>분류</p>  
            <p class='bo_v_con_1st_pr'><?php echo cut_str(get_text($view['ca_name']), 70); // 글제목 출력 ?></p>
        </div> 
        <div class="bo_v_con_1st_con">
            <p class='bo_v_con_1st'>게시판 유형</p>  
            <p class='bo_v_con_1st_pr'><?php echo cut_str(get_text($view['wr_2']), 70); // 글제목 출력 ?></p>
        </div> 
        <div class="bo_v_con_1st_con">
            <p class='bo_v_con_1st'>게시판명</p>  
            <p class='bo_v_con_1st_pr'><?php echo cut_str(get_text($view['subject']), 70); // 글제목 출력 ?></p>
        </div> 
-->
...
-->
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
            <?php if($bo_table=='main_port'){ ?>
           <li><a href="/bbs/content.php?co_id=community/#community_move" onclick="handleCommunityParam(event)" class="btn_b01 btn" >목록</a></li>
            <?}else{?>
            <li><a href="/bbs/content.php?co_id=community/#community_move" onclick="handleCommunityParam(event)" class="btn_b01 btn">목록</a></li>
            <? } ?>
            <?php if ($is_admin == 'super' || $is_auth || defined('G5_IS_ADMIN') || $member['mb_id'] == 'admin02') {  ?> 
                <li><a href="https://hochicken.co.kr/bbs/board.php?bo_table=table_event" class="btn_b01 btn">리스트 목록</a></li>
            <?php }  ?>
        </ul>
...
<script>
    function handleCommunityParam(event) {
        const url = 'https://hochicken.co.kr/bbs/content.php?co_id=community&step=step_02#community_move';
