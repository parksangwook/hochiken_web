...
-->
						<tr class="tr_sort">
							<td class='td_sort'>제목<b>*</b><span class="sound_only"> 제목 </span></td>
							<td><input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="k_input_sort frm_input full_input required k_input k_input_w100" size="50" maxlength="255" placeholder="제목을 입력해주세요."></td>
						</tr>
						<tr class="tr_sort">
							<td class='td_sort'>작성자<b>*</b><span class="sound_only"> 작성자 </span></td>
							<td><input type="text" name="wr_2" value="<?php echo $subject ?>" id="wr_2" required class="k_input_sort frm_input full_input required k_input k_input_w100" size="50" maxlength="255" placeholder="작성자을 입력해주세요."></td>
						</tr>
                        <tr class="option-box tr_sort">
							<td class='td_sort' width=200>고정<b>*</b><span class="sound_only"></span></td>
							<td >
								<select name="wr_7" id="wr_7" class="frm_input k_input k_input_sort" style="font-size: 1rem;">
