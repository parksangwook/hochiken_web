    ...
    <?php } ?>
				...
				<div id="k_w_bo" style="margin-top: 50px;">
					<table class="k_w_table">
						...
						<tr class="tr_sort">
							<td class='td_sort'>매장명<b>*</b><span class="sound_only"> 매장명 </span></td>
							<td><input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="k_input_sort frm_input full_input required k_input k_input_w100" size="50" maxlength="255" placeholder="매장명을 입력해주세요."></td>
						</tr>
                        <tr class="tr_sort">
							<td class='td_sort'>주소<b>*</b><span class="sound_only"> 주소 </span></td>
							<td><input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="k_input_sort frm_input full_input required k_input k_input_w100" size="50" maxlength="255" placeholder="주소을 입력해주세요."></td>
						</tr>
                        <tr class="tr_sort">
							<td class='td_sort'>전화번호<b>*</b><span class="sound_only"> 전화번호 </span></td>
							<td><input type="text" name="wr_3" value="<?php echo $wr_3 ?>" id="wr_3" required class="k_input_sort frm_input full_input required k_input k_input_w100" size="50" maxlength="255" placeholder="전화번호을 입력해주세요."></td>
						</tr>
                        <tr class="tr_sort">
							<td class='td_sort'>영업시간<b>*</b><span class="sound_only"> 영업시간 </span></td>
							<td><input type="text" name="wr_4" value="<?php echo $wr_4 ?>" id="wr_4" required class="k_input_sort frm_input full_input required k_input k_input_w100" size="50" maxlength="255" placeholder="영업시간을 입력해주세요."></td>
						</tr>
