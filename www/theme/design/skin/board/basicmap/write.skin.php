...
-->
                        ...
                        <tr class="tr_sort">
							...
							<td><input type="text" name="wr_4" value="<?php echo $wr_4 ?>" id="wr_4" required class="k_input_sort frm_input full_input required k_input k_input_w100" size="50" maxlength="255" placeholder="주소를 입력해주세요."></td>
						</tr>
...
<!--
						...
						<tr class="tr_sort">
							<?php if($i == "0"){ ?>
								<td class='td_sort'>매장 사진 #<?php echo $i+1 ?></td>
							<? }else{ ?>
								<td class='td_sort'>매장 사진 #<?php echo $i+1 ?></td>
							<? } ?>
